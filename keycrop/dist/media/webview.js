...
Uses: ${this._num_hotkey_uses}`;
  ...
  if (potWrapper) {
    ...
    updateOverlay2 = updateOverlay, updateCookButton2 = updateCookButton, syncPotUI2 = syncPotUI, refreshHighlights2 = refreshHighlights, addToPot2 = addToPot, removeFromPot2 = removeFromPot;
